...
describe("Component: temperature-unit", async () => {
    ...
    it.each([
        ...
        const { getByText, getByTitle } = withRender(<TempUnit decimals={decimal} symbol value={kelvin} />, { settings });
    ...
    it("should work without decimal.", (
        ...
        const settings = { temperatureScale: TemperatureScale.CELSIUS };
        const { getByText, getByTitle } = withRender(<TempUnit symbol value={274.284} />, { settings });
